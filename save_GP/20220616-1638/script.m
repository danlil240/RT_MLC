% C:\RT_MLC\SAVE_GP\20220616-1638\SCRIPT parameters scropt for MLC
% Type mlc=MLC('C:\RT_MLC\save_GP\20220616-1638\script') to create corresponding MLC object
parameters.size = 50;
...
parameters.savedir = 'C:\RT_MLC\save_GP\20220616-1638';
