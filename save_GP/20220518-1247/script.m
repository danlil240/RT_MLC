% C:\RT_MLC\SAVE_GP\20220518-1247\SCRIPT parameters scropt for MLC
% Type mlc=MLC('C:\RT_MLC\save_GP\20220518-1247\script') to create corresponding MLC object
parameters.size = 200;
...
parameters.opsetrange = [1 3 5 8 9];
parameters.formal = 0;
...
parameters.savedir = 'C:\RT_MLC\save_GP\20220518-1247';
