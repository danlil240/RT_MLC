% C:\RT_MLC\SAVE_GP\20220502-1624\SCRIPT parameters scropt for MLC
% Type mlc=MLC('C:\RT_MLC\save_GP\20220502-1624\script') to create corresponding MLC object
parameters.size = 300;
...
parameters.savedir = 'C:\RT_MLC\save_GP\20220502-1624';
