% C:\RT_MLC\SAVE_GP\20220509-1920\SCRIPT parameters scropt for MLC
% Type mlc=MLC('C:\RT_MLC\save_GP\20220509-1920\script') to create corresponding MLC object
parameters.size = 200;
...
parameters.savedir = 'C:\RT_MLC\save_GP\20220509-1920';
