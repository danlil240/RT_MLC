% C:\RT_MLC\SAVE_GP\20220518-1245\SCRIPT parameters scropt for MLC
% Type mlc=MLC('C:\RT_MLC\save_GP\20220518-1245\script') to create corresponding MLC object
parameters.size = 200;
...
parameters.savedir = 'C:\RT_MLC\save_GP\20220518-1245';
