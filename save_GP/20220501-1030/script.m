% C:\RT_MLC\SAVE_GP\20220501-1030\SCRIPT parameters scropt for MLC
% Type mlc=MLC('C:\RT_MLC\save_GP\20220501-1030\script') to create corresponding MLC object
parameters.size = 300;
...
parameters.savedir = 'C:\RT_MLC\save_GP\20220501-1030';
