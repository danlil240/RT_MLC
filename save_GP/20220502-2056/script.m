% C:\RT_MLC\SAVE_GP\20220502-2056\SCRIPT parameters scropt for MLC
% Type mlc=MLC('C:\RT_MLC\save_GP\20220502-2056\script') to create corresponding MLC object
parameters.size = 500;
...
parameters.savedir = 'C:\RT_MLC\save_GP\20220502-2056';
