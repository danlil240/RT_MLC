% C:\RT_MLC\SAVE_GP\20220508-1701\SCRIPT parameters scropt for MLC
% Type mlc=MLC('C:\RT_MLC\save_GP\20220508-1701\script') to create corresponding MLC object
...
parameters.range = 3000;
parameters.precision = 6;
parameters.opsetrange = [1 3 5];
parameters.formal = 0;
...
parameters.savedir = 'C:\RT_MLC\save_GP\20220508-1701';
