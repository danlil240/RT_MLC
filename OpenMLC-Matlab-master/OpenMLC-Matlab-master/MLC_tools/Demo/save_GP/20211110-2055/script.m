% G:\.SHORTCUT-TARGETS-BY-ID\1_RIG9VP-7WNP5WJDBS9BW8YF09Y8UCIT\פיתוח אלגוריתם בקרה מבוסס מכונה לומדת לדיכוי רעידות במערכת דרגת חופש אחת\LITERATURE REVIEW\BOOK\OPENMLC-MATLAB-MASTER\OPENMLC-MATLAB-MASTER\MLC_TOOLS\DEMO\SAVE_GP\20211110-2055\SCRIPT parameters scropt for MLC
% Type mlc=MLC('G:\.shortcut-targets-by-id\1_riG9vp-7WNp5wjdBS9bw8yf09Y8ucIT\פיתוח אלגוריתם בקרה מבוסס מכונה לומדת לדיכוי רעידות במערכת דרגת חופש אחת\literature review\Book\OpenMLC-Matlab-master\OpenMLC-Matlab-master\MLC_tools\Demo\save_GP\20211110-2055\script') to create corresponding MLC object
parameters.size = 50;
...
parameters.savedir = 'G:\.shortcut-targets-by-id\1_riG9vp-7WNp5wjdBS9bw8yf09Y8ucIT\פיתוח אלגוריתם בקרה מבוסס מכונה לומדת לדיכוי רעידות במערכת דרגת חופש אחת\literature review\Book\OpenMLC-Matlab-master\OpenMLC-Matlab-master\MLC_tools\Demo\save_GP\20211110-2055';
