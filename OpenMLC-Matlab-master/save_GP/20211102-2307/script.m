% SAVE_GP\20211102-2307\SCRIPT parameters scropt for MLC
% Type mlc=MLC('save_GP\20211102-2307\script') to create corresponding MLC object
parameters.size = 100;
...
parameters.savedir = 'save_GP\20211102-2307';
