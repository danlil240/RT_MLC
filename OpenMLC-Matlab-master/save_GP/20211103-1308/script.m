% SAVE_GP\20211103-1308\SCRIPT parameters scropt for MLC
% Type mlc=MLC('save_GP\20211103-1308\script') to create corresponding MLC object
parameters.size = 100;
...
parameters.savedir = 'save_GP\20211103-1308';
