% D:\GOOGLE DRIVE\ZIV\SCE\PROJECT PROPOSALS\OCTOBER 2021\פיתוח אלגוריתם בקרה מבוסס מכונה לומדת לדיכוי רעידות במערכת דרגת חופש אחת\LITERATURE REVIEW\BOOK\OPENMLC-MATLAB-MASTER\OPENMLC-MATLAB-MASTER\SAVE_GP\20210923-1004\SCRIPT parameters scropt for MLC
% Type mlc=MLC('D:\google drive\ziv\SCE\Project proposals\October 2021\פיתוח אלגוריתם בקרה מבוסס מכונה לומדת לדיכוי רעידות במערכת דרגת חופש אחת\literature review\Book\OpenMLC-Matlab-master\OpenMLC-Matlab-master\save_GP\20210923-1004\script') to create corresponding MLC object
parameters.size = 50;
...
parameters.savedir = 'D:\google drive\ziv\SCE\Project proposals\October 2021\פיתוח אלגוריתם בקרה מבוסס מכונה לומדת לדיכוי רעידות במערכת דרגת חופש אחת\literature review\Book\OpenMLC-Matlab-master\OpenMLC-Matlab-master\save_GP\20210923-1004';
