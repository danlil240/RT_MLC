% SAVE_GP\20211103-1054\SCRIPT parameters scropt for MLC
% Type mlc=MLC('save_GP\20211103-1054\script') to create corresponding MLC object
parameters.size = 100;
...
parameters.savedir = 'save_GP\20211103-1054';
